...
import 'package:flutter_basic_ui/models/message_data.dart';
import 'package:flutter_basic_ui/widgets/icon_button.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: Center(
              child: IconBorder(
                  icon: CupertinoIcons.photo_camera_solid, onTap: () {}),
            ),
          )
        ],
      ),
